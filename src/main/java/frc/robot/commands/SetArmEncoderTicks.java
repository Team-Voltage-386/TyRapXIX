...
public class SetArmEncoderTicks extends Command {
  ...
  //private final double pk = 0.9, ik = 0, dk = 0; //pk = 0.02, ik = 0.001, dk = ??
  ...
  protected void execute() {
    ...
    d = errorChange * SmartDashboard.getNumber("dk ", 0);
    p = error * SmartDashboard.getNumber("pk ", 0);
    i += error * SmartDashboard.getNumber("ik ", 0);
    speed = p + i + d;
