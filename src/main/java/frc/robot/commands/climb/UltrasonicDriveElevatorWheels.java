...
// /**
// * Runs elevator wheels, climb arm wheels, and drive train once bot is lifted
// to
// * drive it onto the platform. Uses ultrasonic distance to ensure it only
// drives
...
// private final double CLIMB_ARMS_HOLDING_SPEED = -0.4; // Push Down to Hold
// Front TEST 30%
// private final double ELEVATOR_HOLDING_SPEED = -0.3; // Push Down to Hold Back
// private final double ELEVATOR_WHEELS_SPEED = -0.6; // Drives Forwards - lower
// experimentally
