...
// /**
// * Initialize begins a timer which is checked along with the current on the
// arm
...
// private final double ELEVATOR_DROP_SPEED = -0.2; // TEMP - just needs to be
...
// // PDP current statements ensure motors stop when pushing down on the
// platform
// return Timer.getFPGATimestamp() - startTime > 0.5 &&
// Robot.endgameClimbSubsystem.getPDPCurrent(4) > 4
