...
// bestPairChange = Math
// .abs(VisionProcessing.getPairCenter(pairs.get(0)) -
...
// for (int i = 0; i < pairs.size(); i++) {
// if (Math.abs(
// VisionProcessing.getPairCenter(pairs.get(i)) -
// VisionProcessing.getPairCenter(bestPair)) < bestPairChange) {
// indx = i;
// bestPairChange = Math
// .abs(VisionProcessing.getPairCenter(pairs.get(indx)) -
// VisionProcessing.getPairCenter(bestPair));
// }
...
// (-.8 * OI.xboxDriveControl.getRawAxis(RobotMap.driveLeftJoystickVertical) + p
// + d + i),
// -OI.xboxDriveControl.getRawAxis(RobotMap.driveLeftJoystickVertical) - p - d -
// i);
...
// } else {
// Robot.driveSubsystem.driveTank(-0.8 *
