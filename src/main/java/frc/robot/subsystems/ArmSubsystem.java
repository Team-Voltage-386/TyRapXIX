...
public class ArmSubsystem extends Subsystem {
    ...
    private static final int PEAK_CURRENT_AMPS = 55; /*
    ...
    public ArmSubsystem() {
        ...
        elbowMotor.configPeakCurrentDuration(PEAK_TIME_MS); /*
                                                             * this is a necessary call to avoid errata.
                                                             */
    ...
    public void setElbowMotorSpeed(double power) {
        ...
        if (power > 0.05 && getElbowPotentiometerVoltage() > MIN_ELBOW_VOLTAGE) {
            power = /* DOWNWARDS_ELBOW_LIMITER */
                    SmartDashboard.getNumber("ElbowDownLimiter ", DOWNWARDS_ELBOW_LIMITER) * power;
