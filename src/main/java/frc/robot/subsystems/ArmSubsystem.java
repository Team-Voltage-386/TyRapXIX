...
// private static final int PEAK_CURRENT_AMPS = 55; /* threshold to trigger
// current limit */
// private static final int PEAK_TIME_MS = 0; /* how long after Peak current to
// trigger current limit */
// private static final int CONTIN_CURRENT_AMPS = 39; /* hold current after
// limit is triggered */
// private static final double OPEN_LOOP_RAMP_SECONDS = 0.1;

// // Doubles for PID Calculations
// private double shoulderP = 0, elbowP = 0, elbowI = 0, elbowD = 0, elbowResetP
// = 0;
// private double prevError = 0, error = 0, errorChange = 0, elbowPower = 0,
// shoulderPower = 0;

// // Constants for Calculations
// public static final double SHOULDER_PK = -30, MAX_ERROR_FOR_I_USE = 0.3;
// public static final double ELBOW_PK = 2.5, ELBOW_IK = 0.1, ELBOW_DK = 0.0,
// ELBOW_RESET_PK = 2.5;
...
// public static WPI_TalonSRX elbowMotor = new
// WPI_TalonSRX(RobotMap.elbowMotor);

// // Potentiometer
// AnalogInput shoulderPotentiometer = new
// AnalogInput(RobotMap.shoulderPotentiometer);
// AnalogInput elbowPotentiometer = new
// AnalogInput(RobotMap.elbowPotentiometer);
...
// elbowMotor.configPeakCurrentDuration(PEAK_TIME_MS); /* this is a necessary
...
// SmartDashboard.putNumber("Elbow Potentiometer",
// getElbowPotentiometerVoltage());
// SmartDashboard.putNumber("Elbow Raw Power", elbowMotor.get());
// }

// /** Shoulder Enumerations used in CargoMode and HatchMode Commands */
// public enum Levels {
// cargoFloorPickup, cargoPlayerStation, cargoLevelOne, cargoLevelTwo,
// cargoLevelThree, hatchFloorPickup,
...
// */
// public void setLevel(Levels inShoulder, ElbowStates inElbow, double
// manualOverrideShoulder,
...
// *
// * @param positionGoal The goal position (percentage representation as a
// double
// * from 0.0 to 1.0)
// */
...
// errorChange = error - prevError;
// elbowP = error * /* elbowPK */ SmartDashboard.getNumber("elbowPK ",
// ELBOW_PK);
...
// elbowI += error * /* elbowIK */ SmartDashboard.getNumber("elbowIK ",
// ELBOW_IK);
// } else {
// elbowI = 0;
// }
// elbowD = errorChange * /* elbowDK */ SmartDashboard.getNumber("elbowDK ",
// ELBOW_DK);
...
// SmartDashboard.putNumber("errorChange ELBOW", errorChange); // temp for
// testing?
// SmartDashboard.putNumber("elbowI ", elbowI); // temp for testing?
// SmartDashboard.putNumber("ElbowCurrentGoal", positionVoltage); // May be
// removed from master
// prevError = error;
// }
...
// power = /* DOWNWARDS_ELBOW_LIMITER */
// SmartDashboard.getNumber("ElbowDownLimiter ", DOWNWARDS_ELBOW_LIMITER)
// * power;
// } else if (power < -0.05 && getElbowPotentiometerVoltage() <
// MAX_ELBOW_VOLTAGE) {
...
// *
// * @return The current shoulder position as a percentage represented from 0.0
// to
// * 1.0
// */
