...
// // Current Constants
// private static final int PEAK_CURRENT_AMPS = 35; /* threshold to trigger
// current limit */
// private static final int PEAK_TIME_MS = 0; /* how long after Peak current to
// trigger current limit */
// private static final int CONTIN_CURRENT_AMPS = 25; /* hold current after
// limit is triggered */
// private static final double OPEN_LOOP_RAMP_SECONDS = 0.1;

// // Solenoids
// DoubleSolenoid modeSolenoid = new DoubleSolenoid(RobotMap.beakRetractOpen,
// RobotMap.beakRetractClosed);
// DoubleSolenoid hatchSolenoid = new DoubleSolenoid(RobotMap.hatchCaptureOpen,
...
// cargoIntakeMotor.configPeakCurrentDuration(PEAK_TIME_MS); /* this is a
