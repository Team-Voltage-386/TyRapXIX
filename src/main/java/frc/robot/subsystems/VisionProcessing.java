...
public class VisionProcessing extends Subsystem {
  ...
  Size erodeSize = new Size(SmartDashboard.getNumber("ErodeSize1", 50), SmartDashboard.getNumber("ErodeSize2", 50));
  ...
  public ArrayList<RotatedRect[]> visionProcess() {
    ...
    // Vision Thresholds
    colorStart = new Scalar(SmartDashboard.getNumber("Start H", 230), SmartDashboard.getNumber("Start S", 230),
        SmartDashboard.getNumber("Start V", 230));
